  ...
  return (
    <div className=" min-h-screen mt-5">
      <div className="grid grid-cols-12">
        ...
        <div className="col-span-3 border-2 p-5">
          ...
          <p>
            Địa điểm: {thongTinPhim.tenCumRap} - {thongTinPhim.ngayChieu}
          </p>
          <p>
          ...
          <div className="flex flex-row my-5">
            <div className="w-4/5">
              <span className="text-red-400 text-lg w-max">Ghế: </span>
          ...
          <hr />
          <div
            className="mt-5 h-full flex flex-col items-center"
...
export default function (props) {
  ...
  const dispatch = useDispatch();
  const { userLogin } = useSelector((state) => state.QuanLyNguoiDungReducer);
  //Bấm vào trang khác unmout và chạy vào đây
  useEffect(() => {
    return () => dispatch({ type: "CHANGE_TAB_ACTIVE", number: "1" });
  }, []);
  const operations = (
    <Fragment>
      {!_.isEmpty(userLogin) ? (
  ...
  return (
    <div className="p-5">
      ...
      >
        ...
        <TabPane tab="02 KẾT QUÁ ĐẶT VÉ" key="2">
          <KetQuaDatVe {...props} />
        </TabPane>
        <TabPane
          tab={
            <NavLink to="/">
              <HomeOutlined style={{ marginLeft: 5, fontSize: 25 }} />
            </NavLink>
          }
          key="3"
        ></TabPane>
            ...
            <div className="flex-grow">
              ...
              <p>
                ...
                {ticket.danhSachGhe.map((ghe, index) => {
                  return (
                    <span className="text-green-500 text-xl ml-2" key={index}>
                      [{ghe.tenGhe}]{" "}
                    </span>
                  );
                })}
